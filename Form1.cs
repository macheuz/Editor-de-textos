    ...
    public partial class Form1 : Form
    {
        ...
        private void Salvar()
        {
            try
            {
                ...
                {
                    FileStream arquivo = new FileStream(this.saveFileDialog1.FileName, FileMode.OpenOrCreate, FileAccess.Write); 
            ...
            {
                MessageBox.Show("Erro na gravaçao" + ex.Message, "Erro ao gravar", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void abrir()
        {
            ...
            openFileDialog1.InitialDirectory = @"C:\Users\Matheus\Desktop\Projetos Windows Form";
